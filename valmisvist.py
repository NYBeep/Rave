...
paigutus = [[sg.Text('Andmed', text_color='black', font=("Helvetica", 12))],
          ...
          [sg.Text('_' * 80)],
          [sg.Submit('Graafik'), sg.Submit('Sektordiagramm'), sg.Submit('Tulpdiagramm'),  sg.Cancel('Välju')]]
...
while True:
    ...
    if syndmus == 'Graafik':
        ...
        paigutus2 = [[sg.Text('Sisesta graafiku andmed', text_color='black', font=("Helvetica", 12))],
                  [sg.Text('KINDLASTI KASUTA TÜHIKUT PEALE KOMASID JA SEMIKOOLONEID! ')],
                  ...
                  [sg.Text('Hoia meeles, et pead sisestama andmed õiges järjekorras. ', text_color='darkred', font=("helvetica", 10))],
                  [sg.Text('_' * 80)],
                  [sg.Submit('Salvesta'), sg.Cancel('Välju')]]
   
        aken = sg.Window('Vajalikud andmed', paigutus2, size=(600,320))
    ...
    if syndmus == 'Tulpdiagramm':
        ...
        paigutus3 = [[sg.Text('Sisesta tulpdiagrammi andmed', text_color='black', font=("Helvetica", 12))],
                  ...
                  [sg.Text('Sisesta tulpade nimetused (eralda komadega ja maksimum 8): ')],
...
#             print('numbricounts', numbricounts)
            ...
            bar_colors = ["darkolivegreen", "darkorange", "royalblue", "pink", "salmon", "sienna", "grey", "tan"]
    ...
    if syndmus == 'Sektordiagramm':
        ...
        paigutus4 = [[sg.Text('Sisesta sektordiagrammi andmed', text_color='black', font=("Helvetica", 12))],
                  [sg.Text('KINDLASTI KASUTA TÜHIKUT PEALE KOMASID JA SEMIKOOLONEID! ')],
                  [sg.Text('Sisesta nimetused (eralda komadega ja maksimum 8): ')],
        ...
        aken = sg.Window('Vajalikud andmed', paigutus4, size=(600,250))
        ...
        if syndmus3 == 'Salvesta':
            y = np.array(b2int)
            mylabels = a2
            mycolors = ["darkolivegreen", "darkorange", "royalblue", "pink", "salmon", "sienna", "grey", "tan"]
